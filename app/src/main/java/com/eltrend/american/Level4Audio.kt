...
class Level4Audio : AppCompatActivity() {
    private lateinit var mInterstitialAd: InterstitialAd
    lateinit var mAdView: AdView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_level4_audio)
        ...
        cr1.setOnClickListener {
            mInterstitialAd.adListener = object : AdListener() {
                override fun onAdClosed() {
                    ...
                    mInterstitialAd.loadAd(AdRequest.Builder().build())
                    startActivity(Intent(this@Level4Audio, level4U13Audios::class.java))
        ...
        cr2.setOnClickListener {
            mInterstitialAd.adListener = object: AdListener() {
                override fun onAdClosed() {
                    // Code to be executed when the interstitial ad is closed.
                    mInterstitialAd.loadAd(AdRequest.Builder().build())
                    startActivity(Intent(this@Level4Audio,level4U14Audios::class.java))
        ...
        cr3.setOnClickListener {
            mInterstitialAd.adListener = object: AdListener() {
                override fun onAdClosed() {
                    // Code to be executed when the interstitial ad is closed.
                    mInterstitialAd.loadAd(AdRequest.Builder().build())
                    startActivity(Intent(this@Level4Audio, level4U15Audios::class.java))
        ...
        cr4.setOnClickListener {
            mInterstitialAd.adListener = object: AdListener() {
                override fun onAdClosed() {
                    // Code to be executed when the interstitial ad is closed.
                    mInterstitialAd.loadAd(AdRequest.Builder().build())
                    startActivity(Intent(this@Level4Audio, level4U16Audios::class.java))
